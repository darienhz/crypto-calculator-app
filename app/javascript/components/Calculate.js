      ...
      <div>
        ...
        <form onSubmit={this.props.handleSubmit}>
          <div className="form-group">
            ...
            <input onChange={this.props.handleChange} autoComplete="off" type="text" name="name" placeholder="How much do you own?" value={this.props.amount} className="field"></input>
          </div>
          <div className="form-group">
